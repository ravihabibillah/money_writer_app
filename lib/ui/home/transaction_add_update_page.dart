...
class _TransactionAddUpdatePageState extends State<TransactionAddUpdatePage>
  ...
  // final List<GlobalKey<FormState>> _transactionFormKey = [
  //   GlobalKey<FormState>(),
  //   GlobalKey<FormState>()
  // ];
          ...
          body: Container(
            ...
            child: Column(
              children: [
                ...
                Form(
                  ...
                  child: Expanded(
                    child: TabBarView(
                      ...
                      controller: _tabController,
                      children: <Widget>[
                        _buildColumnTransaction(
                            'pengeluaran', provider, context),
                        _buildColumnTransaction('pemasukan', provider, context),
                      ],
                    ),
                  ),
                ...
                // _buildFormTransaction(typeTransaction, provider, context),
              ],
            ),
          ),
        );
          ...
          ElevatedButton(
            ...
            onPressed: () {
              if (_transactionFormKey.currentState!.validate()) {
                ...
                var amountReplaceThousandSeparator = _amountTextController.text
  ...
  //           child: const Text('Simpan'),
  //           onPressed: () {
  //             if (transactionKey.currentState.) {
  //               var idTransaction = _isUpdate ? widget.transaction!.id : null;
  //               var amountReplaceThousandSeparator = _amountTextController.text
  //                   .replaceAll(RegExp(r'[^0-9]'), '');
  //               int? amountToInt = int.tryParse(amountReplaceThousandSeparator);
